  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-gray-400 font-body">Overview of your current operational status and active missions.</p>
      </div>
      ...
      {/* Quick Actions Grid */}
      <h3 className="text-xl font-display font-semibold text-white mt-8 mb-4">Quick Actions</h3>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {quickActions.map((action, i) => (
          ...
          >
            ...
            <h4 className="text-lg font-display font-bold text-white mb-2 group-hover:text-cyber-purple transition-colors">{action.title}</h4>
            <p className="text-sm text-gray-400 font-body">{action.desc}</p>
          </div>
        ))}
      </div>
    </div>
